...
Le cycle 5 Éléments explique la chaîne : Eau faible → Bois mal nourri → Bois ne soutient plus la Terre → Rate en excès de Yin → blocage général.`,
        ...
        pointsUtilises: [
          { code: 'R3', nomIeatc: 'Tai Xi', technique: 'tonification', justification: "Tonifie le Yin du Rein — base du cycle Eau→Bois", ordre: 1 },
        ...
        pointsProposer: [
          { code: 'R3', action: 'tonification', justification: "Tai Xi — source Yin du Rein, nourrit le cycle Eau→Bois" },
      ...
      // [PE2] Praticien expérimenté 2 — grille Cinq Éléments + Zang/Fu
      {
        ...
        pointsUtilises: [
          { code: 'R3', nomIeatc: 'Tai Xi', technique: 'tonification', justification: "Source Yin du Rein — nourrit la base Eau", ordre: 1 },
        ...
        pointsProposer: [
          { code: 'R3', action: 'tonification', justification: "Tai Xi — source Yin du Rein, base Eau du cycle Sheng" },
      ...
      // [Et1] Étudiant 4e année 1 — grille Cinq Éléments
      {
        ...
        pointsUtilises: [
          { code: 'R3', technique: 'tonification', justification: "Source Yin du Rein — nourrit la base Eau", ordre: 1 },
          { code: '8F', technique: 'tonification', justification: "Source du Foie — nourrit le Bois et les tendons", ordre: 2 },
        ...
        pointsProposer: [
          { code: 'R3', action: 'tonification', justification: "Source Yin du Rein — nourrit la base Eau du cycle Sheng" },
          { code: '8F', action: 'tonification', justification: "Source du Foie — nourrit les tendons via le Bois" },
          { code: '34VB', action: 'tonification', justification: "Point hui des tendons — rôle clé dans le Bois" },
...
V20 (Shu de la Rate) tonification — soutenir la Terre, consolider le Réchauffeur Moyen.`,
        pointsUtilises: [
          { code: 'VG4', nomIeatc: 'Ming Men', technique: 'moxa_tonification', justification: "Feu de Ming Men — Yang du Rein", ordre: 1 },
          { code: 'V23', technique: 'moxa_tonification', justification: "Shu du Rein — tonification directe Yang Rein", ordre: 2 },
          { code: 'VC4', nomIeatc: 'Guan Yuan', technique: 'tonification', justification: "Origine Rein — Intestin Grêle — sépare clair et trouble", ordre: 3 },
          { code: 'VG20', nomIeatc: 'Bai Hui', technique: 'moxa_tonification', justification: "Fait monter les Souffles Yang — action sur E/Rte", ordre: 4 },
          { code: 'V20', technique: 'tonification', justification: "Shu de la Rate — soutient le Réchauffeur Moyen", ordre: 5 },
        ],
        niveauConfiance: 'expert',
        sourceType: 'editoriale',
        version: 1,
...
3. Soutenir le Yang Ming (36E, 25E bilatéral).`,
        pointsUtilises: [
          { code: 'VG4', nomIeatc: 'Ming Men', technique: 'moxa_tonification', justification: "Ranime le Feu de Ming Men — racine du Yang", ordre: 1 },
          { code: 'V23', technique: 'moxa_tonification', justification: "Shu du Rein — tonifie directement le Yang du Rein", ordre: 2 },
          { code: 'V20', technique: 'tonification', justification: "Shu de la Rate — réchauffer la Terre", ordre: 3 },
          { code: 'VC12', technique: 'tonification', justification: "Mo de l'Estomac — relancer le Foyer Moyen", ordre: 4 },
        ...
        pointsProposer: [
          { code: 'VG4', action: 'tonification', justification: "Ming Men — Porte de la Vie, racine du Yang — moxa indispensable" },
          { code: 'V23', action: 'tonification', justification: "Shu du Rein — tonification directe du Yang profond" },
          { code: 'V20', action: 'tonification', justification: "Shu de la Rate — réchauffer la Terre depuis le dos" },
          { code: 'VC12', action: 'tonification', justification: "Mo de l'Estomac — relancer le Foyer Moyen" },
...
Le surmenage chronique est l'étiologie typique : la sur-utilisation épuise le Yang du Rein sur des années. Tableau constitutionnel — la guérison prendra plusieurs séries.`,
        ...
        pointsUtilises: [
          { code: 'VG4', nomIeatc: 'Ming Men', technique: 'moxa_tonification', justification: "Yang du Rein — point majeur du Yang du dos", ordre: 1 },
          ...
          { code: 'VC4', nomIeatc: 'Guan Yuan', technique: 'moxa_tonification', justification: "Réchauffer le Foyer Inférieur — Yin et Yang du Rein", ordre: 4 },
          { code: 'V20', technique: 'tonification', justification: "Shu de la Rate — consolide le Foyer Moyen", ordre: 5 },
        ],
        ...
        pointsProposer: [
          { code: 'VG4', action: 'tonification', justification: "Ming Men — Yang du Rein, indispensable avec moxas" },
          ...
          { code: 'VC4', action: 'tonification', justification: "Réchauffer le Foyer Inférieur — Yin/Yang du Rein" },
          { code: 'V20', action: 'tonification', justification: "Shu de la Rate — consolide le Foyer Moyen" },
        ],
      ...
      // [PE1] Praticien expérimenté 1 — Vaisseaux Merveilleux + Zang/Fu
      {
        ...
        pointsUtilises: [
          { code: 'VG4', nomIeatc: 'Ming Men', technique: 'moxa_tonification', justification: "Feu de Ming Men — entrée Du Mai — Yang ascendant", ordre: 1 },
          { code: 'VC4', nomIeatc: 'Guan Yuan', technique: 'tonification', justification: "Ren Mai — Yin de base — ancre le Yang", ordre: 2 },
          { code: 'V23', technique: 'moxa_tonification', justification: "Shu du Rein — soutien direct", ordre: 3 },
          { code: 'VC12', technique: 'tonification', justification: "Foyer Moyen — soutenir la Rate/Estomac", ordre: 4 },
        ],
        ...
        pointsProposer: [
          { code: 'VG4', action: 'tonification', justification: "Ming Men — entrée Du Mai — restaure le Yang ascendant" },
          { code: 'VC4', action: 'tonification', justification: "Guan Yuan — entrée Ren Mai — ancre le Yin de base" },
          { code: 'V23', action: 'tonification', justification: "Shu du Rein — soutien direct du Rein (moxas)" },
          { code: 'VC12', action: 'tonification', justification: "Foyer Moyen — relancer la Rate/Estomac" },
        ],
      ...
      // [PE2] Praticien expérimenté 2 — Trois Foyers + Zang/Fu (anonyme)
      {
        ...
        pointsUtilises: [
          { code: 'VG4', nomIeatc: 'Ming Men', technique: 'moxa_tonification', justification: "Yang du Foyer Inférieur — Ming Men en priorité", ordre: 1 },
          { code: 'V23', technique: 'moxa_tonification', justification: "Shu du Rein — tonification directe Foyer Inférieur", ordre: 2 },
          { code: 'V20', technique: 'tonification', justification: "Shu de la Rate — consolide Foyer Moyen", ordre: 3 },
          { code: 'VC12', technique: 'tonification', justification: "Mo de l'Estomac — renforce la digestion", ordre: 4 },
          { code: 'VC6', technique: 'moxa_tonification', justification: "Réchauffer le Foyer Inférieur directement", ordre: 5 },
        ],
        ...
        pointsProposer: [
          { code: 'VG4', action: 'tonification', justification: "Yang du Foyer Inférieur — Ming Men, moxas indispensables" },
          { code: 'V23', action: 'tonification', justification: "Shu du Rein — tonification directe Foyer Inférieur" },
          { code: 'V20', action: 'tonification', justification: "Shu de la Rate — consolide Foyer Moyen" },
          { code: 'VC12', action: 'tonification', justification: "Mo de l'Estomac — relancer la digestion" },
          { code: 'VC6', action: 'tonification', justification: "Réchauffer directement le Foyer Inférieur" },
        ],
      ...
      // [JP1] Jeune praticien 1 — Yin/Yang simple
      {
        ...
        pointsUtilises: [
          { code: 'VG4', nomIeatc: 'Ming Men', technique: 'moxa_tonification', justification: "Yang du Rein — Ming Men essentiel avec moxas", ordre: 1 },
          { code: '36E', technique: 'moxa_tonification', justification: "Yang général et digestion", ordre: 2 },
          { code: 'VC6', technique: 'moxa_tonification', justification: "Réchauffer le Foyer Inférieur directement", ordre: 3 },
          { code: 'V23', technique: 'moxa_tonification', justification: "Shu du Rein — tonification directe", ordre: 4 },
        ],
        ...
        pointsProposer: [
          ...
          { code: 'VC6', action: 'tonification', justification: "Réchauffer le Foyer Inférieur directement" },
          { code: 'V23', action: 'tonification', justification: "Shu du Rein — soutient le Ming Men" },
        ],
      ...
      // [JP2] Jeune praticien 2 — Cinq Éléments (anonyme)
      {
        ...
        pointsUtilises: [
          { code: 'VG4', nomIeatc: 'Ming Men', technique: 'moxa_tonification', justification: "Yang du Rein — Feu de l'Eau dans les 5 Éléments", ordre: 1 },
          { code: 'R3', nomIeatc: 'Tai Xi', technique: 'tonification', justification: "Source Yin du Rein — nourrit la base Eau", ordre: 2 },
          { code: '36E', technique: 'moxa_tonification', justification: "Soutient la Terre — relance la digestion", ordre: 3 },
          { code: 'V20', technique: 'tonification', justification: "Shu de la Rate — consolide la Terre", ordre: 4 },
        ],
        ...
        pointsProposer: [
          { code: 'VG4', action: 'tonification', justification: "Feu de l'Eau (Ming Men) — Yang du Rein" },
          { code: 'R3', action: 'tonification', justification: "Tai Xi — source Yin du Rein, base Eau du cycle Sheng" },
          { code: '36E', action: 'tonification', justification: "Soutient la Terre — relance la digestion" },
          { code: 'V20', action: 'tonification', justification: "Shu de la Rate — consolide la Terre" },
        ],
      ...
      // [Et1] Étudiant 4e année 1 — Yin/Yang simple
      {
        ...
        pointsUtilises: [
          { code: 'VG4', nomIeatc: 'Ming Men', technique: 'moxa_tonification', justification: "Yang du Rein", ordre: 1 },
          { code: '36E', technique: 'moxa_tonification', justification: "Yang général et digestion", ordre: 2 },
          { code: 'VC6', technique: 'moxa_tonification', justification: "Réchauffer le Foyer Inférieur", ordre: 3 },
        ],
        bilanEnergetique: `1. Vide de Yang au Foyer Inférieur — Ming Men insuffisant\n2. Froid interne — manque de chaleur Yang pour réchauffer le Foyer Moyen\n3. Digestion défaillante le matin — Yang ne monte pas à l'heure GI (5h-7h)`,
      ...
      // [Et2] Étudiant 4e année 2 — Trois Foyers + Zang/Fu (anonyme)
      {
        ...
        pointsUtilises: [
          { code: 'VG4', nomIeatc: 'Ming Men', technique: 'moxa_tonification', justification: "Yang du Foyer Inférieur — priorité absolue", ordre: 1 },
          { code: 'V23', technique: 'moxa_tonification', justification: "Shu du Rein — tonification directe", ordre: 2 },
          { code: 'V20', technique: 'tonification', justification: "Shu de la Rate — consolide Foyer Moyen", ordre: 3 },
          { code: 'VC12', technique: 'tonification', justification: "Mo de l'Estomac — renforce la digestion", ordre: 4 },
        ],
        bilanEnergetique: `1. Foyer Inférieur vide de Yang — Rein insuffisant, froid lombaire\n2. Foyer Moyen fragilisé secondairement — Rate/Estomac sans soutien\n3. Diarrhées matinales = Foyer Inférieur ne retient plus les liquides`,
        ...
        pointsProposer: [
          { code: 'VG4', action: 'tonification', justification: "Ming Men — Yang du Foyer Inférieur" },
          { code: 'V23', action: 'tonification', justification: "Shu du Rein — tonification directe Foyer Inférieur" },
          { code: 'V20', action: 'tonification', justification: "Shu de la Rate — consolide Foyer Moyen" },
          { code: 'VC12', action: 'tonification', justification: "Mo de l'Estomac — relancer la digestion" },
        ],
...
F3 dispersion — disperser le Yang du Foie, libère la montée.`,
        pointsUtilises: [
          { code: 'R3', nomIeatc: 'Tai Xi', technique: 'tonification', justification: "Nourrit le Yin du Rein — point source", ordre: 1 },
          { code: 'V23', technique: 'tonification', justification: "Renforcer le Rein (Shu du Rein)", ordre: 2 },
          { code: 'V15', technique: 'tonification', justification: "Soutenir le Cœur — palpitations, insomnies", ordre: 3 },
          { code: 'F2', technique: 'dispersion', justification: "Disperser le Yang du Foie", ordre: 4 },
          { code: 'F3', nomIeatc: 'Tai Chong', technique: 'dispersion', justification: "Disperser le Yang montant du Foie", ordre: 5 },
        ],
        niveauConfiance: 'expert',
        sourceType: 'editoriale',
        version: 1,
...
4. Points Shu du dos pour soutenir Rein et Cœur.`,
        pointsUtilises: [
          { code: 'R3', nomIeatc: 'Tai Xi', technique: 'tonification', justification: "Yin du Rein — nourrit la base du cycle", ordre: 1 },
          { code: 'V23', technique: 'tonification', justification: "Shu du Rein — renforce le Yin profond", ordre: 2 },
          { code: 'V15', technique: 'tonification', justification: "Shu du Cœur — pacifie le Shen, calme les palpitations", ordre: 3 },
          { code: 'C7', nomIeatc: 'Shen Men', technique: 'harmonisation', justification: "Porte du Shen — calme le Cœur et l'anxiété", ordre: 4 },
          { code: 'F3', nomIeatc: 'Tai Chong', technique: 'dispersion', justification: "Disperse le Yang du Foie", ordre: 5 },
          { code: 'F2', technique: 'dispersion', justification: "Clarifie le Feu du Foie", ordre: 6 },
          { code: 'VB20', technique: 'dispersion', justification: "Fait descendre le Yang montant du Foie — céphalées, vertiges", ordre: 7 },
        ],
...
3. Abaisser le Yang montant.`,
        pointsUtilises: [
          { code: 'VB20', technique: 'dispersion', justification: "Pacifie le Vent du Foie — point clé du Vent interne", ordre: 1 },
          { code: 'F3', nomIeatc: 'Tai Chong', technique: 'dispersion', justification: "Pacifie le Foie et le Vent interne", ordre: 2 },
          { code: 'R3', nomIeatc: 'Tai Xi', technique: 'tonification', justification: "Nourrit le Yin du Rein — traite la cause", ordre: 3 },
          { code: '6Rte', technique: 'tonification', justification: "Nourrit le Yin en général — soutien du Sang", ordre: 4 },
          { code: 'VG20', technique: 'dispersion', justification: "Abaisser le Yang en excès au sommet — utiliser avec précaution", ordre: 5 },
        ],
...
Note : 2F est ici en tonification pour nourrir le Yin — à distinguer de la dispersion 2F pour vider le Yang (hypertension).`,
        pointsUtilises: [
          ...
          { code: 'VG4', nomIeatc: 'Ming Men', technique: 'tonification', justification: "Renforce le Yang des Reins (base du Yin)", ordre: 2 },
          { code: 'R3', nomIeatc: 'Tai Xi', technique: 'tonification', justification: "Tonifie directement le Yin du Rein", ordre: 3 },
