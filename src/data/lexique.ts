...
export const LEXIQUE: Term[] = [
  ...
  },
  {
    ...
    synonymes: ['Shao Yang de pied (VB)', 'Shao Yang de main (TR)'],
  ...
  },
  {
    id: 'feu_du_vide',
    terme: 'Feu du vide',
    definition: "Chaleur interne qui provient NON d'un excès mais d'un vide de Yin. Quand le Yin est insuffisant, le Yang (relatif) n'est plus ancré et monte librement — produisant de la chaleur. Signes : chaleur vespérale, sueurs nocturnes, langue rouge sans enduit, bourdonnements. Se traite en nourrissant le Yin — PAS en dispersant la chaleur.",
    synonymes: ['Chaleur du vide', 'Yang relatif ascendant'],
    correspondanceMtc: 'Xu Huo',
