...
const TECHNIQUE_CONFIG: Record<TechniquePoint, { label: string; className: string }> = {
  ...
  neutre: { label: 'Neutre', className: 'bg-gray-100 text-gray-700 border-gray-300' },
  moxa: { label: 'Moxa', className: 'bg-orange-50 text-orange-700 border-orange-200' },
  moxa_tonification: { label: 'Moxa Ton.', className: 'bg-orange-100 text-orange-800 border-orange-200' },
  moxa_dispersion: { label: 'Moxa Dis.', className: 'bg-orange-100 text-red-800 border-orange-200' },
